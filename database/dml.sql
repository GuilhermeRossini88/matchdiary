...
-- ('Flamengo', 'RJ', 'https://example.com/flamengo.png'),
-- ('Corinthians', 'SP', 'https://example.com/corinthians.png'),
-- ('Palmeiras', 'SP', 'https://example.com/palmeiras.png'),
-- ('São Paulo', 'SP', 'https://example.com/saopaulo.png'),
-- ('Santos', 'SP', 'https://example.com/santos.png'),
-- ('Vasco', 'RJ', 'https://example.com/vasco.png'),
-- ('Grêmio', 'RS', 'https://example.com/gremio.png'),
-- ('Internacional', 'RS', 'https://example.com/internacional.png'),
-- ('Atlético Mineiro', 'MG', 'https://example.com/atleticomg.png'),
-- ('Cruzeiro', 'MG', 'https://example.com/cruzeiro.png');

-- INSERT INTO match (date, team_one_id, score_team_one, team_two_id, score_team_two, team_supported_id) VALUES
-- ('2024-06-01', 1, 2, 2, 1, 1),
-- ('2024-06-02', 3, 1, 4, 3, 3),
-- ('2024-06-03', 5, 0, 6, 0, 5),
-- ('2024-06-04', 7, 2, 8, 2, 7),
-- ('2024-06-05', 9, 3, 10, 1, 9),
-- ('2024-06-06', 2, 1, 3, 2, 2),
-- ('2024-06-07', 4, 2, 5, 1, 4),
-- ('2024-06-08', 6, 3, 7, 3, 6),
-- ('2024-06-09', 8, 1, 9, 2, 8),
-- ('2024-06-10', 10, 0, 1, 2, 10);
